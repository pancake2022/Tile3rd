...
//public class M3CollectionCellUI : M3CellUI
//{
//    public M3CollectionUI CollectionUI { get; private set; }//收集ui
...
//    public M3CollectionCellUI Init (M3CollectionUI collection_ui)//初始化
//    {
//        CollectionUI = collection_ui;
//        return this;
//    }

//    public M3CollectionCellUI StartCollect (M3FlyCellUI fly_cell_ui)//开始收集
//    {
...
//    public M3CollectionCellUI CompleteCollect (M3FlyCellUI fly_cell_ui)//完成收集
//    {
...
//    public M3CollectionCellUI StartMatch ()//开始match
//    {
...
//    public M3CollectionCellUI ChangeIndexInCollection (int index, List<Vector3> position_list, bool with_animation)//变换顺序
//    {
...
//            else
//            {
//                warning($"M3CollectionCellUI[{IndexInCollection}][{Cell.X}, {Cell.Y}] condition error");//其他情况报错

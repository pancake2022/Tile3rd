...
public class M3GameFlyCellUI : M3GameCellUI
{
    private SchedulerFloat _fly_scheduler = new SchedulerFloat().Init(0.3f);//飞行速度是0.5
    public M3GameCollectionCellUI TargetM3CollectionCellUI;//目标是CollectionCellUI
    private Action _completed_callback;//行为完成回调

    public M3GameFlyCellUI Init (M3Cell cell, Action completed_callback)//初始化
    {
    ...
    public M3GameFlyCellUI StartFly(M3GameHighLightCellUI high_light_cell_ui, M3GameCollectionCellUI collection_cell_ui)//开始飞行
    {
